...
// Apple's UIKit/AppKit headers define NSLayoutAttributeBaseline and
// NSLayoutAttributeLastBaseline as aliases of the same enumerator value.
// The two-key entries below are intentional for readability and have no
// runtime effect (the dictionary literal will keep one). Silence the
// duplicate-keys warning for this third-party file only.
